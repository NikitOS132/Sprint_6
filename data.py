class TestData:
    test_data_user1 = ['Станислав', 'Игорев', 'Видное', 'Зябликово', '89664327044', '15.06.2024', '536379']

    test_data_user2 = ['Гвардеец', 'Имперский', 'Раменское', 'Котельники', '89254703411', '19.06.2024', '524615']
    
    test_data_question_answer = [
        [1, 'Сутки - 400 рублей. Оплата курьеру - наличными или картой.']
        [2, 'Пока у нас так: один заказ - один самокат. Если хотите покататься с друзьями, '
        ...
        [6, 'Самокат приезжает к вам с полной зарядкой. Этого хватает на 8 суток - даже если будете кататься '
